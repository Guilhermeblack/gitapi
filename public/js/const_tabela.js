function sleep(milliseconds) {
          ...
          renderColumns: function(event, data) {
              ...
              if(!node.hasChildren()){
                ...
                //   $tdList.eq(4).find("input").val(node.data.unidade);
                  $tdList.eq(3).find("input").val(aux.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'}));
                //   $tdList.eq(6).find("input").val(calc_total(node).toLocaleString('pt-br',{style: 'currency', currency: 'BRL'}));
                  ...
                  $tdList.eq(1).text(node.getIndexHier());
                  $tdList.eq(3).find("input").val(calc_total(node).toLocaleString('pt-br',{style: 'currency', currency: 'BRL'}));
              }
          }
          ...
          tree.visit(function(fn){
              ...
              if(fn.hasChildren()){
                ...
                //   no.push(orcamento);
                  ...
                  isNaN(parseFloat($tdList.eq(3).find("input").val().replace(/[R$,.]/g, ''))) ? no.push('') : no.push($tdList.eq(3).find("input").val().replace(/[R$. ]/g, '').replace(/,/g, '.'));
  ...
  function atualiza_no(){
      ...
      if(fn != null){
          ...
          if(!(fn.hasChildren())){
            ...
            //   }
                ...
                $tdList.eq(3).find("input").val().toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
    ...
    //           // Validacao e armazenamento dos campos quantidade e valor Unitario
    //         //   if($tdList.eq(8).find("input").val() != null && $tdList.eq(5).val() != null ){
  ...
  $("select#orcamento").change(function() {
      ...
      if($('select#orcamento >  option:selected').val() != -1){
          ...
          */
          ...
          tree_tarefa.reload({
              url: "orcamentos/default_tarefa.json"
          }).done(function() {
              define_contextMenu(editable, "table#orc_tarefa");
          });
